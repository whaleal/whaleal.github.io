...
![image-20240712170434492](../../images/whalealPlatFromImages/15-AdministratorWhaleal/IntegrationwithPrometheus.png)

3.Select grafana json file to import

![image-20240712170501595](../../images/whalealPlatFromImages/15-AdministratorWhaleal/IntegrationwithPrometheus1.png)

4.Click import

![image-20240716112410796](../../images/whalealPlatFromImages/15-AdministratorWhaleal/IntegrationwithPrometheus2.png)

5.Configuration Complete

![image-20240716112103625](../../images/whalealPlatFromImages/15-AdministratorWhaleal/IntegrationwithPrometheus3.png)
