...
1. Click the **Create Cluster** dropdown menu.
   ...
   ![StandaloneAdvanced](../../images/whalealPlatFromImages/04-CreateDeployment/CreateCluster.png)

2. Select **Standalone**.

   ![StandaloneAdvanced](../../images/whalealPlatFromImages/04-CreateDeployment/AllCluster.png)
...
1. Click **Add Option**.
   ...
   ![StandaloneAdvanced](../../images/whalealPlatFromImages/04-CreateDeployment/Standalone.png)
