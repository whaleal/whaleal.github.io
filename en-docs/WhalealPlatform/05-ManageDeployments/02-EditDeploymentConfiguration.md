...
1. Click **Add Option**.
   ...
   ![StandaloneAdvanced](../../images/whalealPlatFormImages/05-ManageDeployments/StandaloneAdvanced.png)

2. Click **Select** and select the configuration option.

   ![StandaloneAdvanced](../../images/whalealPlatFormImages/05-ManageDeployments/StandaloneAdd.png)
...
![StandaloneAdvanced](../../images/whalealPlatFormImages/05-ManageDeployments/ReplSetConfiguration.png)
...
![StandaloneAdvanced](../../images/whalealPlatFormImages/05-ManageDeployments/ConfigureEachReplicaSetMember.png)
...
![StandaloneAdvanced](../../images/whalealPlatFormImages/05-ManageDeployments/ConfigureyourReplicationSettings.png)
...
1. Click **Add Options**.
   ...
   ![StandaloneAdvanced](../../images/whalealPlatFormImages/05-ManageDeployments/ReplAdvanced.png)
...
![StandaloneAdvanced](../../images/whalealPlatFormImages/05-ManageDeployments/ModifyClusterWideSettings.png)
...
1. Click **Add a Shard**.
   ...
   ![StandaloneAdvanced](../../images/whalealPlatFormImages/05-ManageDeployments/addshard1.png)
...
![StandaloneAdvanced](../../images/whalealPlatFormImages/05-ManageDeployments/ConfigServerReplicaSetSettings.png)
...
![StandaloneAdvanced](../../images/whalealPlatFormImages/05-ManageDeployments/MongosSettings.png)
...
![StandaloneAdvanced](../../images/whalealPlatFormImages/05-ManageDeployments/ConfigureEachReplicaSetinyourCluster.png)
